...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'New Patient Registration.create': {
    ...
    key: 'new_patient_registration',
    tenantPath: [],
    userPath: [],
  },
  'Appointment Confirmation.update': {
    roles: ['healthcare-provider', 'system-administrator'],
    key: 'appointment_confirmation',
    tenantPath: [],
    userPath: [],
  },
  'Schedule Update.update': { roles: ['healthcare-provider'], key: 'schedule_update', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['system-administrator'];
const customerRoles: string[] = ['guest'];
const tenantRoles: string[] = ['system-administrator', 'healthcare-provider'];
