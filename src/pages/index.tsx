  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Doctor Appointment System: Revolutionizing the Way You Schedule Your Health - Streamlining Processes, Saving Time, and Prioritizing Your Well-being."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Doctor Appointment System: Revolutionizing the Way You Schedule Your Health - Streamlining Processes, Saving Time, and Prioritizing Your Well-being.`}
            </Text>
            <Box
