  ...
  const fetcher = useCallback(
    async () =>
      getAppointments({
        ...
        order: params.order,
        searchTermKeys: ['appointment_time.contains', 'status.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.appointment_date ? format(parseISO(record?.appointment_date as unknown as string), 'dd-MM-yyyy') : '',
    },
