...
import { getHealthRecordById } from 'apiSdk/health-records';
import { HealthRecordInterface } from 'interfaces/health-record';

function HealthRecordViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('health_record', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/health-records/edit/${id}`} passHref legacyBehavior>
                    <Button
